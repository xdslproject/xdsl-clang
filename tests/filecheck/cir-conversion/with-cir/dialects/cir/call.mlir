...
// CHECK-NEXT:   %[[X:.*]] = cir.call @f3() : () -> !cir.int<s, 32>
// CHECK-NEXT:   cir.return %[[X]] : !cir.int<s, 32>
// CHECK-NEXT: }
...
// CHECK-NEXT:   %[[A:.*]] = cir.const #cir.int<1> : !cir.int<s, 32>
// CHECK-NEXT:   %[[B:.*]] = cir.const #cir.int<2> : !cir.int<s, 32>
// CHECK-NEXT:   %[[C:.*]] = cir.call @f5(%[[A]], %[[B]]) : (!cir.int<s, 32>, !cir.int<s, 32>) -> !cir.int<s, 32>
// CHECK-NEXT:   cir.return %[[C]] : !cir.int<s, 32>
// CHECK-NEXT: }
...
// CHECK:      cir.func @f7(%[[PTR:.*]]: !cir.ptr<!cir.func<(!cir.int<s, 32>, !cir.int<s, 32>) -> !cir.int<s, 32>>>) -> !cir.int<s, 32> {
// CHECK-NEXT:   %[[A:.*]] = cir.const #cir.int<1> : !cir.int<s, 32>
// CHECK-NEXT:   %[[B:.*]] = cir.const #cir.int<2> : !cir.int<s, 32>
// CHECK-NEXT:   %[[RET:.*]] = cir.call %[[PTR]](%[[A]], %[[B]]) : (!cir.ptr<!cir.func<(!cir.int<s, 32>, !cir.int<s, 32>) -> !cir.int<s, 32>>>, !cir.int<s, 32>, !cir.int<s, 32>) -> !cir.int<s, 32>
// CHECK-NEXT:   cir.return %[[RET]] : !cir.int<s, 32>
// CHECK-NEXT: }
