...
// CHECK-NEXT:   %{{.*}} = cir.objsize max %arg0 : !cir.ptr<!cir.void> -> !cir.int<u, 64>
// CHECK-NEXT:   cir.return %{{.*}} : !cir.int<u, 64>
// CHECK-NEXT: }
...
// CHECK-NEXT:   %{{.*}} = cir.objsize max nullunknown %arg0 : !cir.ptr<!cir.void> -> !cir.int<u, 64>
// CHECK-NEXT:   cir.return %{{.*}} : !cir.int<u, 64>
// CHECK-NEXT: }
...
// CHECK-NEXT:   %{{.*}} = cir.objsize max dynamic %arg0 : !cir.ptr<!cir.void> -> !cir.int<u, 64>
// CHECK-NEXT:   cir.return %{{.*}} : !cir.int<u, 64>
// CHECK-NEXT: }
...
// CHECK-NEXT:   %{{.*}} = cir.objsize max nullunknown dynamic %arg0 : !cir.ptr<!cir.void> -> !cir.int<u, 64>
// CHECK-NEXT:   cir.return %{{.*}} : !cir.int<u, 64>
// CHECK-NEXT: }
...
// CHECK-NEXT:   %{{.*}} = cir.objsize min %arg0 : !cir.ptr<!cir.void> -> !cir.int<u, 64>
// CHECK-NEXT:   cir.return %{{.*}} : !cir.int<u, 64>
// CHECK-NEXT: }
...
// CHECK-NEXT:   %{{.*}} = cir.objsize min nullunknown %arg0 : !cir.ptr<!cir.void> -> !cir.int<u, 64>
// CHECK-NEXT:   cir.return %{{.*}} : !cir.int<u, 64>
// CHECK-NEXT: }
...
// CHECK-NEXT:   %{{.*}} = cir.objsize min dynamic %arg0 : !cir.ptr<!cir.void> -> !cir.int<u, 64>
// CHECK-NEXT:   cir.return %{{.*}} : !cir.int<u, 64>
// CHECK-NEXT: }
...
// CHECK-NEXT:   %{{.*}} = cir.objsize min nullunknown dynamic %arg0 : !cir.ptr<!cir.void> -> !cir.int<u, 64>
// CHECK-NEXT:   cir.return %{{.*}} : !cir.int<u, 64>
// CHECK-NEXT: }
